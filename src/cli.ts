 ...
 *
 * Usage:
 *   spike serve [options]       Start MCP multiplexer server (stdio)
 *   spike shell [options]       Interactive REPL to explore MCP tools
...
async function main(): Promise<void> {
  ...
  program
    .name("spike")
    .description("MCP multiplexer — aggregate multiple MCP servers into one")
    .version(VERSION)
